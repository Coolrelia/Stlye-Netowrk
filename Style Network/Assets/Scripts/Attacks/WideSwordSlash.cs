...
public class WideSwordSlash : MonoBehaviour
{
    public int damage;
    ...
    void IncreaseRank()
    {
        if (transform.parent.GetComponent<Player>().previousAttack == 'W')
        {
            transform.parent.GetComponent<Player>().previousAttack = 'W';
        }
        else
        {
            sm.rank += 1;
